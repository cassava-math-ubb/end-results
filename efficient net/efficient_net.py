...
def save_model(_model):
    ...
    with open('model_8epchs.json', "w") as json_file:
        json_file.write(model_json)
    _model.save_weights('weights_8epchs.h5')
...
if __name__ == '__main__':
    ...
    model_save = ModelCheckpoint('best_model_8epchs.h5',
                                 save_best_only=True,
    ...
    reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.3,
                                  ...
                                  mode='min')
    tensorboard = TensorBoard(log_dir=f"run8epchs/logs/scalars/{datetime.now().strftime('%Y%m%d-%H%M%S')}")
    ...
    # evaluate model
    model.load_weights("best_model_8epchs.h5")
